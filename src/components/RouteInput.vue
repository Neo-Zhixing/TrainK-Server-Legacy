<template>
    ...
    <b-input-group-button>
      <b-button @click="swapStations" variant="secondary"><font-awesome-icon :icon="swapIcon"/></b-button>
    </b-input-group-button>
...
export default {
  ...
  computed: {
    swapIcon () { return faArrowsAltH }
  },
  methods: {
    swapStations () {
      let temp = this.value.departureStation
      this.value.departureStation = this.value.arrivalStation
      this.value.arrivalStation = temp
    }
  },
  components: {
    StationInput
...
<style>
  ...
  #arrival-input.route-station-input .multiselect__tags {
